...
const PrivateClass = () => {
  return (
    <div>
    <main className={css["private-bg"]}>
      <div className={css["main-box"]}>
        <h1>Private Yoga Classes</h1>
      </div>
    </main>
    <div className={css["second-div"]} style={{background: "linear-gradient(135deg, rgb(97, 97, 97) 0%, rgb(191, 191, 191) 50%, white)"}}>
